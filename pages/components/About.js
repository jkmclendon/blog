  ...
  return (
    <div className="flex flex-col w-1/5 max-h-3/6 m-12 p-8 fixed right-1 top-12 bg-gradient-to-b from-secondary to-primary rounded-xl items-center">
      ...
      <div className="card flex items-center max-w-full">
        <h2 className="card-title text-neutral use-megrim">Julian McLendon</h2>
        <p className="use-quicksand">Welcome to my Blog! This is where I will share my thoughts and document my journey as a software engineer. I don&apos;t plan to enable comments on my posts, but you can still interact with them by clicking the gem icon.</p>
      </div>
    </div>
  )
}